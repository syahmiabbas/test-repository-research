...
4.	PSR MS then invokes Payment MS via HTTP POST and sends userID, sellerID, total price, description of purchase, sellerÃ¢ÂÂs stripeAccountID and paymentMethodID
