...
4.	PSR MS then invokes Payment MS via HTTP POST and sends userID, sellerID, total price, description of purchase, sellerÃÂ¢ÃÂÃÂs stripeAccountID and paymentMethodID
